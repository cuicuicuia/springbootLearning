package com.calm_seas.demo.utils;
...
public class AliOssUtil {
   private static final String endpoint = "https://oss-cn-shenzhen.aliyuncs.com";
    ...
    private static final String ACCESS_KEY_ID="LTAI5t8MFbQkndYRsTkJG4r1";
    private static final String ACCESS_KEY_SECRET="lr89xtydtV01thrcxcVHCWCHJqCyCr";
    private static final String bucketName = "calmseas";
